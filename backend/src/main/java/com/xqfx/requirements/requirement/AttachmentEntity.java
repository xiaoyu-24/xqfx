...
class AttachmentEntity {
    ...
    Long id(){return id;} String originalName(){return originalName;} String storedName(){return storedName;} String contentType(){return contentType;} long sizeBytes(){return sizeBytes;} String checksum(){return checksum;} AttachmentPreviewStatus previewStatus(){return previewStatus;} String previewContentType(){return previewContentType;} String previewRelativePath(){return previewRelativePath;} String previewErrorMessage(){return previewErrorMessage;}
